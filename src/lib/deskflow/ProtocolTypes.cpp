...
const char *const kMsgDFileTransferEdge = "DFTE%S";
...
const char *const kMsgCInputLangStatus = "CILS%s%1i%1i";
const char *const kMsgCDisplayLayout = "CDLY%4I";
const char *const kMsgCForegroundFullscreen = "CFLS%1i";
