...
<p align="center">
  <a href="https://github.com/victoriousian/ieum/releases/tag/v0.1.0-alpha.4"><strong>이음 다운로드</strong></a>
...
> 현재 단계는 `v0.1.0-alpha.4`입니다. 자동 빌드와 단위 테스트는 통과했지만 Windows/macOS 실기
...
[이음 (Ieum) v0.1.0-alpha.4 릴리스](https://github.com/victoriousian/ieum/releases/tag/v0.1.0-alpha.4)

| 운영체제 | 설치 파일 |
| --- | --- |
| Apple Silicon Mac | `Ieum-0.1.0-alpha.4-macos-arm64.dmg` |
| Intel Mac | `Ieum-0.1.0-alpha.4-macos-x86_64.dmg` |
| Intel/AMD 64비트 Windows | `Ieum-0.1.0-alpha.4-win-x64.msi` |
| Intel/AMD 64비트 Windows 한국어 설치 화면 | `Ieum-0.1.0-alpha.4-win-x64-ko-KR.msi` |
| ARM64 Windows | `Ieum-0.1.0-alpha.4-win-arm64.msi` |
| ARM64 Windows 한국어 설치 화면 | `Ieum-0.1.0-alpha.4-win-arm64-ko-KR.msi` |
